...
export default function NavBar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-background/60 relative">
      {/* place the light rays behind content */}
      <LightRays className="absolute inset-0 -z-10" raysColor="#00ffff" followMouse={true} />
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <Button asChild className="hidden sm:flex" size="sm">
              <Link href="https://www.linkedin.com/in/kishore1010" target="_blank">
                Connect on{" "}
                <svg
                  xmlns=""
                  width="12"
